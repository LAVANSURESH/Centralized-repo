...
name: Multi-Repo Orchestration Agent
description: This agent orchestrates changes across multiple repositories from this centralized repository. It coordinates workflows, propagates updates, and ensures consistency across all managed repositories.
